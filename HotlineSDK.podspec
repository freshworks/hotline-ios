...
Pod::Spec.new do |s|
  ...
  s.author             = { "Freshdesk" => "hotline@freshdesk.com" }
  ...
  s.resources = "HotlineSDK/HLResources.bundle", "HotlineSDK/KonotorModels.bundle", "HotlineSDK/HLLocalization/en.lproj/HLLocalizable.strings"
  s.ios.vendored_library = "HotlineSDK/libFDHotlineSDK.a"
  s.frameworks = "Foundation", "AVFoundation", "AudioToolbox", "CoreMedia", "CoreData", "ImageIO", "SystemConfiguration","AdSupport"
